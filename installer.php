...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211227_beautifulshoping_df8c37145a90d8d73314_20220217090425_archive.zip';
	const ARCHIVE_SIZE		 = '80663773';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'df8c371-17090425';
    const SECONDARY_PACKAGE_HASH = '1a4f7c8-17090425';
	const VERSION			 = '1.4.3';
